...
_asset_dir = os.path.join(_test_dir, 'assets')


def check_arrays_close(a: np.ndarray, 
                            b: np.ndarray, 
                            a_name: str='a', 
                            b_name: str='b', 
                            msg: str='',
...
def _evaluate_arrays_close(a: np.ndarray, b: np.ndarray, msg: str="", atol: float=1e-08, rtol: float=1e-05) -> str:
